...
Target Resource:
IAM-Project-Access (Security Group)
...
Configured:
Review Name:
IAM-Project-Access-Monthly-Review
Review Type:
Teams + Groups
Selected group:
IAM-Project-Access
...
Navigated to:
Groups → IAM-Project-Access → Members
Confirmed:
lab-user1 removed from group
